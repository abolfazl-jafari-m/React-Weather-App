...
} from "../../Context/LoadingContext.tsx";
...
function MainPage() {
  ...
  return (
    <WeatherProvider>
      <div
        className={
          "w-full min-h-screen bg-[url(/images/cloudy-wallpaper.webp)] grid grid-cols-12 bg-no-repeat bg-center bg-cover font-fuzzy text-white"
        }
      >
        <Aside />
        <Contents />
      ...
      {isLoading && (
        <div
          className={
            "w-full h-screen fixed top-0 left-0 bg-gray-700/60 flex items-center justify-center"
          }
        >
          <div
            className={
              " p-2 rounded-lg drop-shadow-lg shadow-lg shadow-black bg-zinc-700"
            }
          >
