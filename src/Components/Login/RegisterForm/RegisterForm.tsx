...
function RegisterForm() {
    ...
    const {handleSubmit, register, formState: {errors} , getValues} = useForm<RegsterFormType>();
                ...
                <div className={"flex flex-col gap-2"}>
                    <div
                        ...
                        <input type={"text"} className={"bg-transparent py-1 px-3 rounded-md outline-none"}
                               placeholder={"Please Enter Your Name"} {...register("email", {
                ...
                <div className={"flex flex-col gap-2"}>
                    <div
                        ...
                        <input type={!showPass ? "password" : "text"}
                               ...
                               placeholder={"Repeat Your Password..."} {...register("rePassword", {
                                required: "this Field is Required",
                                pattern: {
                                    value: REGEX_PASSWORD,
                                    message: "Your password have to Contains 8 character & digits & Special Letter"
