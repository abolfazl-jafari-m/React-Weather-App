...
function LoginForm() {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<LoginFormType>({ defaultValues: { email: "", password: "" } });
    ...
    >
      ...
      >
        <div className={"flex flex-col gap-2"}>
          ...
          <div
            className={"text-xs text-red-400 tracking-tighter px-2 min-h-7 "}
          >
          ...
          >
            ...
            <div className={"flex items-center w-full"}>
              <input
                ...
                className={
                  "bg-transparent py-1 px-3 flex-1 rounded-md outline-none"
                }
